...
trainig_set_file_name = '{}_{}_{}.csv'.format(total_set_size, tranining_set_percentage, testing_set_percentage)
...
write_ordereddict_list_to_file(final_training_set_rows, 'output.csv')
